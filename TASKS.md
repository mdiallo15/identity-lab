...
- **2026-05-10 (cont.)** — Third task this session: T-01c SSRF v2 live fetcher sandbox shipped (8e4829c). 10-payload catalog + naive vs hardened fetchers + sandboxed `/api/ssrf-fetch`. Hardened rule chain labelled (H-SCHEME / H-CRLF / H-HEADERS / H-CANON / H-IPRANGE / H-IPV6 / H-PINIP). Remaining outstanding work: T-01 (JWT workbench copy-as-curl polish), T-02 (Agent Identity token-exchange e2e).
