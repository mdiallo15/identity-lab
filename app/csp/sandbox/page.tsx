  ...
  return (
    <>
      ...
      <p className="lede">
        ...
        back into the console mirror. Pick a scenario from the catalog to load
        a preset, or paste your own header and payload.
      </p>
      ...
      >
        ...
        console mirror below. Limitations of meta-CSP: <code>frame-ancestors</code>,{" "}
        <code>sandbox</code>, and <code>report-to</code> are header-only and
        won&apos;t fire here. Everything else does.
      </div>
      ...
      <h2 style={{ marginTop: "1.6rem" }}>Live sandbox</h2>
      ...
      <p style={{ color: "var(--ink-dim)", fontSize: "0.88rem" }}>
        Same 12-rule grader as the analyzer page, run live against the policy
        in the editor.
      </p>
    ...
    return (
      <div className="csp-console-line violation">
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <code>{d.violatedDirective || d.effectiveDirective}</code>{" "}
          blocked <code style={{ wordBreak: "break-all" }}>{d.blockedURI || "inline"}</code>
          {d.sample && (
            <div
              style={{
                marginTop: "0.2rem",
